<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="#"><i class="fa fa-fw fa-dashboard"></i> Peso</a>
                    </li>
                    <li>
                        <a href="{{route('panel-de-administrador.block.index')}}"><i class="fa fa-fw fa-bar-chart-o"></i> Comentarios </a>
                    </li>
                    @if(Auth::user()->trainer())
                    <li>

                        <a href="#"><i class="fa fa-fw fa-table"></i> clientes</a>
                    </li>
                    @endif
                    <li>
                        <a href="{{route('panel-de-administrador.clientTrainers.create')}}"><i class="fa fa-fw fa-edit"></i> Nuevo articulo</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
